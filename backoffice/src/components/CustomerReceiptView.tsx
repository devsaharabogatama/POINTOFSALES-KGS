...
type Invoice = { sourceType: SourceType; sourceId: string; salesId: string | null; invoiceNo: string; customerId: string; storeName: string | null; transactionDate: string; dueDate: string | null; originalReceivable: number; allocatedAmount: number; remainingAmount: number }
