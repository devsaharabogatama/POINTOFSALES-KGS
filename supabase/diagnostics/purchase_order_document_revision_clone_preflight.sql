-- Clone variant: runtime/dependency guards unchanged; historical Development fixture is replaced by rollback preparation.
...
WITH checks AS (
  ...
  UNION ALL
  SELECT 'revision_development_fixture','SETUP',
    0,
    jsonb_build_object('eligibleConfirmedDailyPo',count(*),'fixtureRule','Prepare canonical AUTO_PO inside purchase_order_pre_receipt_revision_clone_behavior.sql; rollback after test',
