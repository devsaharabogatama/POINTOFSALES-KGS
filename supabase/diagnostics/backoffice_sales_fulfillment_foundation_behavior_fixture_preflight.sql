-- SELECT-only fixture inventory for fulfillment foundation rollback behavior.
WITH eligible_companies AS (
  ...
  UNION ALL
  SELECT 'canonical_fulfillment_company_fixture',
  ...
  WHERE table_schema = 'public'
    AND table_name = 'user_active_company_contexts'
