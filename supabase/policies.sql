...
DROP POLICY IF EXISTS "Warehouses viewable by company members" ON warehouses;
...
DROP POLICY IF EXISTS "Warehouses manageable by company owner/admin" ON warehouses;
...
DROP POLICY IF EXISTS "Products viewable by company members" ON products;
...
DROP POLICY IF EXISTS "Products manageable by company owner/admin" ON products;
...
DROP POLICY IF EXISTS "Bundle items viewable by company members" ON product_bundle_items;
...
DROP POLICY IF EXISTS "Bundle items manageable by company owner/admin" ON product_bundle_items;
...
DROP POLICY IF EXISTS "Stocks viewable by company members" ON product_stocks;
...
DROP POLICY IF EXISTS "Stocks manageable by company owner/admin/warehouse" ON product_stocks;
...
DROP POLICY IF EXISTS "Customers viewable by company members" ON customers;
...
DROP POLICY IF EXISTS "Customers manageable by company staff" ON customers;
...
DROP POLICY IF EXISTS "Sessions viewable by authorized company/store staff" ON cashier_sessions;
...
DROP POLICY IF EXISTS "Sessions insertable by cashiers" ON cashier_sessions;
...
DROP POLICY IF EXISTS "Sessions updateable by cashiers or managers" ON cashier_sessions;
...
DROP POLICY IF EXISTS "Sales headers viewable by company/store members" ON sales_headers;
...
DROP POLICY IF EXISTS "Sales headers insertable by cashier staff" ON sales_headers;
...
DROP POLICY IF EXISTS "Sales details viewable by company members" ON sales_details;
...
DROP POLICY IF EXISTS "Sales details insertable by company members" ON sales_details;
...
DROP POLICY IF EXISTS "Sales payments viewable by company members" ON sales_payments;
...
DROP POLICY IF EXISTS "Sales payments insertable by company members" ON sales_payments;
...
DROP POLICY IF EXISTS "Purchases headers viewable by company members" ON purchases_headers;
...
DROP POLICY IF EXISTS "Purchases details viewable by company members" ON purchases_details;
...
DROP POLICY IF EXISTS "Cash advances viewable by company/store members" ON cash_advances;
...
DROP POLICY IF EXISTS "Cash advances insertable by cashiers" ON cash_advances;
...
DROP POLICY IF EXISTS "Cash advances manageable by company owner/admin" ON cash_advances;
...
DROP POLICY IF EXISTS "Bank deposits viewable by company/store members" ON bank_deposits;
...
DROP POLICY IF EXISTS "Accounting events viewable by company owner/admin/finance" ON financial_events;
...
DROP POLICY IF EXISTS "Accounting entries viewable by company owner/admin/finance" ON journal_entries;
...
DROP POLICY IF EXISTS "Reconciliation viewable by company owner/admin/finance" ON pos_reconciliations;
...
DROP POLICY IF EXISTS "Uoms viewable by company members" ON uoms;
CREATE POLICY "Uoms viewable by company members" ON uoms
    FOR SELECT TO authenticated USING (private_user_has_company_access(company_id));

DROP POLICY IF EXISTS "Uoms manageable by company owner/admin" ON uoms;
...
DROP POLICY IF EXISTS "Conversions viewable by company members" ON product_uom_conversions;
CREATE POLICY "Conversions viewable by company members" ON product_uom_conversions
    FOR SELECT TO authenticated USING (private_user_has_company_access(company_id));

DROP POLICY IF EXISTS "Conversions manageable by company owner/admin" ON product_uom_conversions;
...
DROP POLICY IF EXISTS "Batches manageable by company owner/admin" ON product_batches;
...
DROP POLICY IF EXISTS "FIFO allocations viewable by company owner/admin/finance" ON sales_fifo_allocations;
...
DROP POLICY IF EXISTS "Opnames viewable by company owner/admin" ON stock_opnames;
...
DROP POLICY IF EXISTS "Opnames manageable by company owner/admin" ON stock_opnames;
...
DROP POLICY IF EXISTS "Opname details viewable by company owner/admin" ON stock_opname_details;
CREATE POLICY "Opname details viewable by company owner/admin" ON stock_opname_details
    FOR SELECT TO authenticated USING (private_user_has_company_access(company_id));

DROP POLICY IF EXISTS "Opname details manageable by company owner/admin" ON stock_opname_details;
...
DROP POLICY IF EXISTS "Adjustments viewable by company owner/admin" ON stock_adjustments;
...
DROP POLICY IF EXISTS "Adjustments insertable by company owner/admin" ON stock_adjustments;
