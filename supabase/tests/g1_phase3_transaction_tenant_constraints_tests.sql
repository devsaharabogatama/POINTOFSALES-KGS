...
BEGIN
    ...
    INSERT INTO public.cashier_sessions (
        ...
        ('00000000-0000-0000-0000-000000003061','G3-SA1',v_actor,'00000000-0000-0000-0000-000000003001','00000000-0000-0000-0000-000000003011','00000000-0000-0000-0000-000000003021','CLOSED'::session_status),
        ('00000000-0000-0000-0000-000000003062','G3-SA2',v_actor,'00000000-0000-0000-0000-000000003001','00000000-0000-0000-0000-000000003012','00000000-0000-0000-0000-000000003022','CLOSED'::session_status);
    ...
    BEGIN
        INSERT INTO public.cashier_sessions (
            session_code,cashier_id,company_id,store_id,pos_id,status
        )
        VALUES (
            'G3-FORGED-SESSION',v_actor,
            '00000000-0000-0000-0000-000000003001',
            '00000000-0000-0000-0000-000000003011',
            '00000000-0000-0000-0000-000000003022',
