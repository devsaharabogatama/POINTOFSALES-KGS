...
BEGIN
 ...
 RAISE NOTICE 'PASS: canonical shortage/closed session; preserved request identity/value; source released; confirmed SO/DO; exact retry; revision reduce/reinstate/cap; stale denial; cancellation; stock/FIFO/Finance unchanged; all fixtures rollback';
END $test$;
ROLLBACK;
