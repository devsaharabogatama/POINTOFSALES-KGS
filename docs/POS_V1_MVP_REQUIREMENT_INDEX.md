...
| PUR-001 | Purchasing | Sales/Kasir membuat Request Order; Store Manager menentukan Supplier/qty dan membuat Supplier Order. Penerimaan tersedia dari sesi Kasir PWA atau Backoffice Gudang berizin; keduanya wajib memakai satu canonical Stock/FIFO/AP/Finance Post. | `PRODUCT_STOCK_MASTERDATA_SPEC.md`, `runbooks/BACKOFFICE_GOODS_RECEIPT_ROLLOUT.md` | G5 |
